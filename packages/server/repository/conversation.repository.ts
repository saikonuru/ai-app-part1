...
const DEFAULT_SYSTEM_PROMPT = `You are a helpful assistant. Based on the conversation history, provide a short and concise answer to the user's last message. Do not repeat the conversation history in your response.`;
