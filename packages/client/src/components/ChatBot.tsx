  ...
  return (
    <div className="flex flex-col gap-3 mb-10">
      ...
      {messages.map((message, index) => (
        <div
          key={index}
          className={`px-3 py-1 rounded-xl text-left
          ${
            message.role === 'user'
      ...
      {isBotTyping && (
        <div className="flex self-start gap-1 px-3 py-3 bg-gray-200 rounded-xl">
          ...
          <div className="w-2 h-2 rounded-full bg-gray-800 animate-pulse [animation-delay:0.2ms]" />
          <div className="w-2 h-2 rounded-full bg-gray-800 animate-pulse [animation-delay:0.4ms]" />
        </div>
      )}
